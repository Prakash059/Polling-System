...
//validate club form
function clubValidate(clubForm){

var validationVerified=true;
var errorMessage="";
var okayMessage="click OK to see the candidates under the chosen club";

if (clubForm.club.selectedIndex == 0)
{
errorMessage+="Club not set!\n";
validationVerified=false;
}
if(!validationVerified)
{
